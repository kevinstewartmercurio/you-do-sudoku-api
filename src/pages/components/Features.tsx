...
const cards: Card[] = [
  ...
  },
  {
    ...
    content:
      "Responses are served in JSON format, making for easy use and reliable integration.",
  },
  {
    svg: (
      <svg
      ...
      <div id="features" className="flex flex-col items-center">
        <div className="md:max-w-3xl lg:max-w-6xl mb-3 sm:mb-5 px-6 flex flex-col lg:flex-row justify-center">
          ...
          <div className="text-secondary lg:ml-8 text-sm sm:text-base lg:text-lg font-inter">
            The YouDoSudoku API is designed to be light on resources, ensuring a
        ...
        <div className="px-4 flex flex-col lg:flex-row">
          {cards.map((card, idx) => (
            <div
              key={idx}
              className={`bg-feature-card-bg rounded-md lg:w-1/3 max-w-lg lg:max-w-sm md:mx-2.5 my-1 sm:my-1.5 lg:my-0 px-3.5 py-4 xs:py-5 sm:py-6 flex flex-col feature-card`}
            >
              <div className="mb-2.5 flex items-center">
                <div className="text-feature-card-icon">{card.svg}</div>
