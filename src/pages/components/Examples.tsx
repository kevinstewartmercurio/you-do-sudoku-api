...
const pythonGETText =
  'import requests\n\nheaders = {\n    "Content-Type": "application/json",\n    "x-api-key": "YOUR_YOUDOSUDOKU_API_KEY",\n}\n\nresponse = requests.get("https://youdosudoku.com/api/", headers=headers)\n\nif response.status_code == 200:\n    data = response.json()\n    print(data)\nelse:\n    print(f"Error: {response.status_code}")';
const javascriptGETText =
  'fetch("https://youdosudoku.com/api/", {\n    method: "GET",\n    headers: {\n        "Content-Type": "application/json",\n        "x-api-key": "YOUR_YOUDOSUDOKU_API_KEY",\n    }\n})\n    .then(response => {\n        if (!response.ok) {\n            throw new Error(`Error: ${response.status}`)\n        }\n        return response.json()\n    })\n    .then(data => {\n        console.log(data)\n    })\n    .catch(error => {\n        console.error(error)\n    })';

const pythonPOSTText =
    ...
    <>
      <code className="w-full flex flex-col items-start">
        ...
        <span className="mb-3.5 sm:mb-4 lg:mb-[18px]">
          <span className="text-code-4">import&nbsp;</span>
          <span className="text-code-0">requests</span>
        </span>
        {/* headers = { */}
        <span>
          <span className="text-code-0">headers =&nbsp;</span>
          <span className="text-code-3">&#123;</span>
        </span>
        {/* "Content-Type": "application/json", */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">&#34;</span>
          <span className="text-code-1">Content-Type</span>
          <span className="text-code-0">&#34;: &#34;</span>
          <span className="text-code-1">application/json</span>
          <span className="text-code-0">&#34;,</span>
        </span>
        {/* "x-api-key": "YOUR_YOUDOSUDOKU_API_KEY", */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">&#34;</span>
          <span className="text-code-1">x-api-key</span>
          <span className="text-code-0">&#34;: &#34;</span>
          <span className="text-code-1">YOUR_YOUDOSUDOKU_API_KEY</span>
          <span className="text-code-0">&#34;,</span>
        </span>
        {/* } */}
        <span className="mb-3.5 sm:mb-4 lg:mb-[18px]">
        ...
        <span className="mb-3.5 sm:mb-4 lg:mb-[18px]">
          <span className="text-code-0">response&nbsp;</span>
          <span className="text-code-3">=&nbsp;</span>
          <span className="text-code-0">requests.</span>
          <span className="text-code-3">get&#40;</span>
          <span className="text-code-0">&#34;</span>
          <span className="text-code-1">https://youdosudoku.com/api/</span>
          <span className="text-code-0">&#34;, headers</span>
          <span className="text-code-3">=</span>
          <span className="text-code-0">headers</span>
          <span className="text-code-3">&#41;</span>
        ...
        {/* if response.status_code == 200: */}
        <span>
          <span className="text-code-4">if&nbsp;</span>
          <span className="text-code-0">response.status.code&nbsp;</span>
          <span className="text-code-3">==&nbsp;</span>
          <span className="text-code-5">200</span>
          <span className="text-code-0">:</span>
        </span>
        {/* data = response.json() */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">data&nbsp;</span>
          <span className="text-code-3">=&nbsp;</span>
          <span className="text-code-0">response.</span>
          <span className="text-code-3">json&#40;&#41;</span>
        </span>
        {/* print(data) */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-3">print&#40;</span>
          <span className="text-code-0">data</span>
          <span className="text-code-3">&#41;</span>
        </span>
        {/* else: */}
        <span>
          <span className="text-code-4">else</span>
          <span className="text-code-0">:</span>
        </span>
        {/* print(f"Error: {response.status_code}") */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-3">print&#40;</span>
          <span className="text-code-4">f</span>
          <span className="text-code-1">&#34;Error:&nbsp;</span>
          <span className="text-code-3">&#123;</span>
          <span className="text-code-0">response.status_code</span>
          <span className="text-code-3">&#125;</span>
          <span className="text-code-1">&#34;</span>
          <span className="text-code-3">&#41;</span>
        </span>
      </code>
    </>
  ...
  return (
    <>
      <code className="w-full flex flex-col items-start">
        {/* fetch("https://youdosudoku.com/api/", { */}
        <span>
          <span className="text-code-3">fetch&#40;</span>
          <span className="text-code-0">&#34;</span>
          <span className="text-code-1">https://youdosudoku.com/api/</span>
          <span className="text-code-0">&#34;&nbsp;</span>
          <span className="text-code-3">&#123;</span>
        ...
        {/* method: "GET", */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">method: &#34;</span>
          <span className="text-code-1">GET</span>
          <span className="text-code-0">&#34;,</span>
        </span>
        {/* headers: { */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
        ...
        <span className="indent-16 sm:indent-20 lg:indent-24">
          ...
          <span className="text-code-1">x-api-key</span>
          <span className="text-code-0">&#34;: &#34;</span>
          <span className="text-code-1">YOUDOSUDOKU_API_KEY</span>
          <span className="text-code-0">&#34;,</span>
        </span>
        {/* } */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
        ...
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">.</span>
          <span className="text-code-3">then&#40;</span>
          <span className="text-code-0">response&nbsp;</span>
          <span className="text-code-3">=&#62; &#123;</span>
        </span>
        {/* if (!response.ok) { */}
        <span className="indent-16 sm:indent-20 lg:indent-24">
          ...
          <span className="text-code-3">&#40;!</span>
          <span className="text-code-0">response.</span>
          <span className="text-code-4">ok</span>
          <span className="text-code-3">&#41; &#123;</span>
        </span>
        {/* throw new Error(`Error: ${response.status}`) */}
        <span className="indent-24 sm:indent-[120px] lg:indent-36">
          <span className="text-code-4">throw new&nbsp;</span>
          <span className="text-code-3">Error&#40;</span>
          <span className="text-code-0">&#96;</span>
          <span className="text-code-1">Error:&nbsp;</span>
          <span className="text-code-3">$&#123;</span>
          <span className="text-code-0">response.</span>
          <span className="text-code-4">status</span>
          <span className="text-code-3">&#125;</span>
          <span className="text-code-0">&#96;</span>
          <span className="text-code-3">&#41;</span>
        </span>
        ...
        {/* return response.json() */}
        <span className="indent-16 sm:indent-20 lg:indent-24">
          <span className="text-code-4">return&nbsp;</span>
          <span className="text-code-0">response.</span>
          <span className="text-code-3">json&#40;&#41;</span>
        </span>
        {/* }) */}
        ...
        {/* console.log(data) */}
        <span className="indent-16 sm:indent-20 lg:indent-24">
          <span className="text-code-0">console.</span>
          <span className="text-code-3">log&#40;</span>
          <span className="text-code-0">data</span>
          <span className="text-code-3">&#41;</span>
        </span>
        {/* }) */}
        ...
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">.</span>
          <span className="text-code-3">catch&#40;</span>
          <span className="text-code-0">error&nbsp;</span>
          <span className="text-code-3">=&#62; &#123;</span>
        </span>
        {/* console.log(data) */}
        <span className="indent-16 sm:indent-20 lg:indent-24">
  ...
  return (
    <>
      <code className="w-full flex flex-col items-start">
        {/* body = { */}
        <span>
          <span className="text-code-0">body&nbsp;</span>
          <span className="text-code-3">= &#123;</span>
        </span>
        {/* "difficulty": "easy" */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">&#34;</span>
          <span className="text-code-1">difficulty</span>
          <span className="text-code-0">&#34;: &#34;</span>
          <span className="text-code-1">easy</span>
          <span className="text-code-0">&#34;,&nbsp;</span>
          <span className="text-code-6">
            &#35; &#34;easy&#34;, &#34;medium&#34;, or &#34;hard&#34; (defaults
            to &#34;easy&#34;)
          </span>
        </span>
        {/* "solution": True */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">&#34;</span>
          <span className="text-code-1">solution</span>
          <span className="text-code-0">&#34;:&nbsp;</span>
          <span className="text-code-4">True</span>
          <span className="text-code-0">,&nbsp;</span>
          <span className="text-code-6">
        ...
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">&#34;</span>
          <span className="text-code-1">array</span>
          <span className="text-code-0">&#34;:&nbsp;</span>
          <span className="text-code-4">False</span>
          <span className="text-code-0">,&nbsp;</span>
          <span className="text-code-6">
        ...
        <span>
          ...
          <span className="text-code-3">=&nbsp;</span>
          <span className="text-code-0">requests.</span>
          <span className="text-code-3">post&#40;</span>
          <span className="text-code-0">&#34;</span>
          <span className="text-code-1">https://youdosudoku.com/api/</span>
          <span className="text-code-0">&#34;, json</span>
          <span className="text-code-3">=</span>
          <span className="text-code-0">body, headers</span>
          <span className="text-code-3">=</span>
          <span className="text-code-0">headers</span>
          <span className="text-code-3">&#41;</span>
        </span>
  ...
  return (
    <>
      <code className="w-full flex flex-col items-start">
        ...
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">method: &#34;</span>
          <span className="text-code-1">POST</span>
          <span className="text-code-0">&#34;,</span>
        </span>
        {/* headers: { */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
        ...
        {/* body: JSON.stringify({ */}
        <span className="indent-8 sm:indent-10 lg:indent-12">
          <span className="text-code-0">body: JSON.</span>
          <span className="text-code-3">stringify&#40;&#123;</span>
        </span>
        {/* difficulty: "easy", */}
        <span className="indent-16 sm:indent-20 lg:indent-24">
          <span className="text-code-0">difficulty: &#34;</span>
          <span className="text-code-1">easy</span>
          <span className="text-code-0">&#34;,&nbsp;</span>
          <span className="text-code-6">
            &#47;&#47; &#34;easy&#34;, &#34;medium&#34;, or &#34;hard&#34;
        ...
        {/* solution: true */}
        <span className="indent-16 sm:indent-20 lg:indent-24">
          <span className="text-code-0">solution:&nbsp;</span>
          <span className="text-code-4">true</span>
          <span className="text-code-0">,&nbsp;</span>
          <span className="text-code-6">
            &#47;&#47; true or false (defaults to true)
        ...
        {/* array: false */}
        <span className="indent-16 sm:indent-20 lg:indent-24">
          <span className="text-code-0">array:&nbsp;</span>
          <span className="text-code-4">false</span>
          <span className="text-code-0">,&nbsp;</span>
          <span className="text-code-6">
            &#47;&#47; true or false (defaults to false)
...
export default function Examples(props: {
  ...
  return (
    <>
      <div id="examples" className="flex flex-col items-center">
        <div className="md:max-w-3xl lg:max-w-6xl mb-3 sm:mb-5 lg:mb-6 px-6 flex flex-col lg:flex-row justify-center">
          ...
          <div className="text-secondary lg:ml-8 text-sm sm:text-base lg:text-lg font-inter">
            Generate a random difficulty puzzle and solution or specifiy how
            you&#39;d like to receive your output.
          </div>
        </div>
        {/* get request */}
        <div className="w-full my-4 flex flex-col items-center">
          ...
          <div className="bg-header-bg border-board border-[1px] border-b-0 rounded-t-2xl w-72 xs:w-5/6 max-w-lg md:max-w-xl lg:max-w-5xl h-10 px-3.5 flex items-center">
            <button
              className={`${
                language === "python"
                  ? "text-examples-accent underline underline-offset-4"
                  : "text-secondary"
              } font-sans text-sm ${
                language !== "python" && "hover:text-primary duration-300"
              }`}
            ...
            <button
              className={`${
                language === "javascript"
                  ? "text-examples-accent underline underline-offset-4"
                  : "text-secondary"
              } ml-3 font-sans text-sm ${
                language !== "javascript" && "hover:text-primary duration-300"
              }`}
