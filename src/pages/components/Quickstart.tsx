            ...
            <div className="flex flex-col items-center">
                ...
                <CopyToClipboard text="https://you-do-sudoku-api.vercel.app/api">
                    <button className="w-full px-4 flex justify-center" onClick={() => dispatch(updateCopied(true))}>
                        ...
                        <div className="text-secondary bg-quickstart-route-bg rounded-r-2xl w-64 xs:w-5/6 max-w-lg lg:max-w-xl px-2.5 py-2.5 text-sm sm:text-base lg:text-lg flex items-center overflow-auto whitespace-nowrap">
                            <code>
